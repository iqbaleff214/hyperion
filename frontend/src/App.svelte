  ...
  <div class="flex h-full">
    ...
    >
      {#if selectedFiles.length > 0}
        ...
        >
          <li
            class="h-[32px] flex items-center p-1 px-2 pe-0.5 text-sm dark:text-white"
          >
            Imported Files
            <!-- svelte-ignore a11y_consider_explicit_label -->
            <div class="ms-auto">
      ...
      {/if}
      <div class="flex flex-col gap-2 overflow-x-hidden overflow-y-auto grow">
        <div
          class="shrink-0 h-[32px] flex items-center gap-1 p-2 dark:text-white w-full border-b border-black/15 dark:border-white/15"
        >
          <div class="grow text-sm">Toolbar</div>
          <button
            class="btn-sm"
        ...
        {#if Object.keys(filesContent).length > 0}
          <div
            class="flex flex-col gap-2 overflow-x-hidden overflow-y-auto p-2 grow"
          >
